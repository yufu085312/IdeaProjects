...
public class AichiToyotaAddress implements IKadai07_5{
    ...
    public Map<String, String> searchByAddress(String addressText) {
        Map<String, String> aichitoyotaaddress = new HashMap<>();
        for(String key: POSTALCODE_MAP.keySet()) {
            String value = POSTALCODE_MAP.get(key);
            if(value.contains(addressText)) {
                aichitoyotaaddress.put(key, value);
            }
        }
        return aichitoyotaaddress;
    }
    ...
    public static void main(String[] args) {
        AichiToyotaAddress ado = new AichiToyotaAddress();
        Map<String, String> MapAddress;
        System.out.println("郵便番号");
        MapAddress = ado.searchByCode("47108");
        for (String key: MapAddress.keySet()) {
            String value = MapAddress.get(key);
            System.out.println("キー：" + key + " 値：" + value);
        }
        System.out.println("地名");
        MapAddress = ado.searchByAddress("愛知県豊田市五ケ丘");
        for (String key: MapAddress.keySet()) {
            String value = MapAddress.get(key);
            System.out.println("キー：" + key + " 値：" + value);
        }
